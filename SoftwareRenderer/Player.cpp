...
void CPlayer::SetPosition(const DirectX::XMFLOAT3& position)
{
...
void CAirplanePlayer::OnUpdateTransform()
{
	...
	m_xmf4x4World = Matrix4x4::Multiply(XMMatrixRotationRollPitchYaw(/*XMConvertToRadians(90.0f)*/0.0f, 0.0f, 0.0f), m_xmf4x4World);
}
