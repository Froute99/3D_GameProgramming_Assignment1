...
void CScene::BuildObjects()
{
	...
	//m_ppObjects[0] = new CRail({ xBase, yBase, zBase });
	//m_ppObjects[1] = new CRail({ xBase, yBase, zBase + offset });
	...
	//m_ppObjects[0]->SetPosition(0.f, 0.f, 100.f);
	
	//m_ppObjects[1] = new CRail();
	//m_ppObjects[1]->SetPosition(position.x - halfRailWidth, position.y, position.z);

	//m_ppObjects[2] = new CRail();
	//m_ppObjects[2]->SetPosition(position.x, position.y, position.z + halfRailDepth);
	//m_ppObjects[2]->Rotate(0.f, 90.f, 0.f);

	//m_ppObjects[3] = new CRail();
	//m_ppObjects[3]->SetPosition(position.x, position.y, position.z - halfRailDepth);
	//m_ppObjects[3]->Rotate(0.f, 90.f, 0.f);
	...
	//m_ppObjects[1]->SetColor(railColor);
	//m_ppObjects[1]->SetPosition(-railWidth, 0.f, 10.f);
